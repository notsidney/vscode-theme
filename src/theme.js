...
function getTheme({ theme, name }) {
	...
	return {
		...
		colors: {
			...
			"titleBar.activeBackground": color.canvas.subtle,
			...
			"commandCenter.background": alpha(color.canvas.inset, 0),
			"commandCenter.activeBackground": color.canvas.inset,
			...
			"tab.unfocusedHoverBackground": color.canvas.subtle,
			...
			"editorLineNumber.foreground": lightDark(scale.gray[2], scale.gray[6]),
		...
		tokenColors: [
			...
			},
			{
				...
				settings: { foreground: color.fg.muted },
			},
			{
				scope: [
					"constant",
				...
				settings: {
					foreground: color.fg.default, // lightDark(scale.blue[6], scale.blue[2]),
				},
			},
			{
				scope: [
			...
			},
			{
				...
				settings: {
					foreground: color.fg.muted, // lightDark(scale.blue[6], scale.blue[2]),
				},
			},
			{
				scope: ["meta.function"],
			...
			},
			{
				...
				settings: {
					// foreground: lightDark(scale.pink[6], scale.pink[3]),
			...
			// },
			{
				...
				settings: {
					foreground: lightDark(scale.orange[5], scale.orange[3]),
				},
			},
			{
				scope: ["storage", "keyword.control.export"],
				settings: {
					// foreground: lightDark(scale.blue[6], scale.blue[2]),
					foreground: lightDark(scale.pink[6], scale.pink[3]),
				},
			...
			},
			{
				scope: "variable",
				settings: {
					foreground: color.fg.default, // lightDark(scale.orange[6], scale.orange[2]),
				},
			},
			{
			...
			},
			{
				...
				settings: {
					foreground: color.fg.subtle, // lightDark(scale.blue[5], scale.blue[3]),
				},
			},
			{
				scope: [
